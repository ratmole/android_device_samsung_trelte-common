...
PRODUCT_COPY_FILES += \
    ...
    $(COMMON_PATH)/configs/permissions/privapp-permissions-com.validity.fingerprint.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/privapp-permissions-com.validity.fingerprint.xml \
